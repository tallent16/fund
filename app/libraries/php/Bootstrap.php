...
//
include( app_path()."/libraries/php/config.php" );
...
spl_autoload_register( function ($class) {
	...
	if ( count( $a ) === 2 ) {
		...
		require( app_path().'/libraries/php/'.'/'.$a[1].'/'.$a[1].'.php' );
		...
		require(app_path().'/libraries/php/'.$a[1].'/'.$location.'.php' );
...
//
 $GLOBALS['moneydb'] = new Database( $sql_details );
