		...
		<div class="col-lg-12 col-md-12">
			<div class="panel panel-primary panel-container">				
					...
					<div class="panel-heading panel-headsection">
						<div class="row">
						   <div class="col-xs-6">
								<span class="pull-left">{{ Lang::get('Project Documents Required') }}</span> 
							</div>									
						</div>                           
					</div>				
						...
						<table class="table tab-fontsize text-left" id="admin_table">
							<thead>
								<tr>									
									...
									<th class="tab-head text-left col-sm-6">{{ Lang::get('Project Documents') }}</th>
		...
		<div class="row">
			<div class="col-sm-12">	
				<button type="button"
						...
						{{ Lang::get('Add New Project Documents')}}
				</button>
				<button type="button"
						id="delete_doc"
						class="btn verification-button"	>
