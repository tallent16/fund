		...
		<div class="col-lg-12 col-md-12">
			<div class="table-responsive">
				<table class="table tab-fontsize table-border-custom text-left" id="adminloanlisting">
					<thead>
						<tr>
							<th class="tab-head text-left">{{ Lang::get('Project Ref No') }}</th>
							...
							<th class="tab-head text-right">{{ Lang::get('Project Applied Amount') }}</th>
							...
							<th class="tab-head text-right">{{ Lang::get('Project Sanctioned Amount') }}</th>
