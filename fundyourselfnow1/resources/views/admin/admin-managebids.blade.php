...
<div class="col-sm-12 space-around">	
	<div class="panel-primary panel-container"><!--panel container-->
			...
			<div class="panel-heading panel-headsection"><!--panel head-->
				<div class="row">
					<div class="col-sm-12">
						<span class="pull-left">{{Lang::get('Manage Project Bids')}}</span> 														
					</div>																
				</div>					
			</div><!--panel head end-->		
								...
								<tbody>
									<tr>
										<td class="tab-left-head col-sm-3">
											{{Lang::get('Project Reference Number')}}
										</td>
										<td>
											{{$bidsModel->loan_reference_number}}
										</td>
										<td class="tab-left-head col-sm-3">
											{{Lang::get('Project Amount')}}
										</td>
										<td>
									...
									<tr>
										<td class="tab-left-head col-sm-3">
											{{Lang::get('Purpose of Project')}}
										</td>										
										<td class="col-sm-3">
											{{$bidsModel->purpose_singleline}}
										</td>
										<td class="tab-left-head col-sm-3">
											{{Lang::get('Tenure of Project')}}
										</td>											
										<td class="col-sm-3">
