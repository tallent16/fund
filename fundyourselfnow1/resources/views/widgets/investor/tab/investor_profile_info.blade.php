					...
					<div class="row">
						...
						<div class="col-xs-12 col-sm-7 col-lg-3" id="identity_card_image_front_parent">									
							...
							@if($InvPrfMod->identity_card_image_front!="")
								<a 	href="{{config('moneymatch_settings.image_url') }}{{$InvPrfMod->identity_card_image_front}}"  
									target="_blank" 
									class="hyperlink">
						...
						<div class="col-xs-12 col-sm-7 col-lg-3" id="identity_card_image_back_parent">									
							...
							@if($InvPrfMod->identity_card_image_back!="")
								<a 	href="{{config('moneymatch_settings.image_url') }}{{$InvPrfMod->identity_card_image_back}}"  
									target="_blank" 
									class="hyperlink">
					...
					<div class="row">
						...
						<div class="col-xs-12 col-sm-7 col-lg-3" id="address_proof_image_parent"	>									
							...
							@if($InvPrfMod->address_proof_image!="")
								<a 	href="{{config('moneymatch_settings.image_url') }}{{$InvPrfMod->address_proof_image}}"  
									target="_blank" 
									class="hyperlink">
