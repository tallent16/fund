		...
		if ($(".select_repayment:checked").length > 0){
			$(".select_repayment:checked").each(function(key) {
				...
				if(status	!=	appr_applicable){
					errMessage	=	errMessage+"Not Applicable for this Project Loan Ref:"+loan_ref+",Schedule Date:";
			...
			$(".select_repayment:checked").each(function(key) {
				...
				if(trans_ref	==	""){ 
					errMessage	=	errMessage+"Transaction Reference Number shoud not be empty for this Project Loan Ref:"+loan_ref+",Schedule Date:";
