...
class LoanDetailsModel extends TranWrapper {
	...
	public function getLoan($loan_id) {
		...
		$loanlist_sql			= "	SELECT 	borrowers.business_name company_name,
											...
											loans.loan_tenure,
											loans.eth_baalance,
											loans.contract_address,loans.ristricted_countries as countries,
											loans.wallet_address,loans.kyc_varify,
											...
											loans.bid_type,
											if(loans.crowd_end_date < now(),'Project Closed',
													datediff(loans.crowd_end_date, now())) days_to_go,
