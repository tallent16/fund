   ...
   Route::get('admin/investorwithdrawalview/view/{payment_id}/{investor_id}', 
	...
	Route::post('admin/role-permission/save', 'AdminRolesController@saveRolePermissionsAction');
	 ...
	 //-------------------------------------------------ajax call actions-----------------------------------
		...
		Route::get('admin/project_calander', 'AdminLoanListingController@myloans');
...
Route::group(['middleware' => 'App\Http\Middleware\BorrowerMiddleWare'], function() {
	...
	Route::match(['get', 'post'],'creator/profile', 'BorrowerProfileController@indexAction');
		  Route::get('creator/project_calander', 'BorrowerMyLoanInfoController@myloan');
...
Route::group(['middleware' => 'App\Http\Middleware\InvestorMiddleWare'], function()
{
	...
	Route::get('backer/wallet', 'CreatorWalletController@indexAction');	
		Route::any('backer/project_calander','InvestorMyLoanInfoController@myloans');
	// Loans 
...
Route::any('project_calander','HomeController@allProjectsPage1');
//static homepage
...
// Add Notifications for loans open and close 
Route::get('addAlertNotification','HomeController@addAlertNotification');
Route::get('followNow/{loan_id}/{status}','AdminNotificationsController@followNow'); 

//Static Pages

Route::any('admin/update/{page}','AdminSettingsController@update_static_page');
Route::post('creator/edit_update','LoanDetailsController@edit_update');
Route::post('creator/add_update','LoanDetailsController@add_update');
Route::post('creator/delete_update','LoanDetailsController@delete_update');
